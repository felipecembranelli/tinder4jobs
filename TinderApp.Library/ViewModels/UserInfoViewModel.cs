...
namespace TinderApp.Library.ViewModels
{
    ...
    {
        private readonly LinkedinJob _data;
        ...
        public string JobPosterName
        {
            get
            {
                return string.Format("{0} {1}",_data.JobPoster.FirstName ,_data.JobPoster.LastName);
            }
        }

        public string JobPosteHeadLine
        {
            get
            {
                return string.Format("{0} {1}", _data.JobPoster.Headline);
            }
        }
        ...
        public string LocationDescription
        {
            get
            {
                return _data.LocationDescription;
            }
        }
        ...
        public string DescriptionSnippet
        {
            get
            {
                return _data.DescriptionSnippet.Replace("/n", "<LineBreak/>");
            }
        }
        ...
        public static async Task<JobInfoViewModel> LoadUserInfo(string id)
        {
            //UserResponse response = await Client.Get<UserResponse>("user/" + id);
            //return new JobInfoViewModel(response.Results);
            return null;
        }
    }
}